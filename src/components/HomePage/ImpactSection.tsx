              ...
              >
                ...
                <div className="relative bg-black/30 backdrop-blur-md border border-white/20 rounded-3xl p-8 h-full transform transition-transform duration-300 group-hover:border-white/30">
                  ...
                  >
                    ...
                    <div className="text-sm text-white/60 mt-1">{card.statLabel}</div>
                  </motion.div>
...
export const ImpactSectionDefaults: ImpactSectionProps = {
  ...
  subheading: "Through comprehensive programs and dedicated support, we're changing lives and building futures.",
  cards: [
    {
      icon: {
      ...
      description: "Providing access to excellent educational resources, experienced teachers, and modern learning facilities to ensure every child gets the foundation they deserve.",
      stat: "98%",
    ...
    },
    {
      ...
      description: "Nurturing individual talents through mentorship programs, life skills training, and character development initiatives that prepare youth for success.",
      stat: "2,500+",
    ...
    },
    {
      ...
      description: "Building strong support networks that provide health services, nutritional programs, and family engagement to ensure holistic development.",
      stat: "15,000+",
